...
static void init_ulp_program()
{
    ...
    rtc_gpio_init(GPIO_PIN_1);
    rtc_gpio_set_direction(GPIO_PIN_1, RTC_GPIO_MODE_INPUT_ONLY);
    rtc_gpio_pullup_dis(GPIO_PIN_1);
    rtc_gpio_pulldown_dis(GPIO_PIN_1);
    rtc_gpio_hold_en(GPIO_PIN_1);
    rtc_gpio_isolate(GPIO_PIN_1);

    rtc_gpio_init(GPIO_PIN_2);
    rtc_gpio_set_direction(GPIO_PIN_2, RTC_GPIO_MODE_INPUT_ONLY);
    rtc_gpio_pullup_dis(GPIO_PIN_2);
    rtc_gpio_pulldown_dis(GPIO_PIN_2);
    rtc_gpio_hold_en(GPIO_PIN_2);
